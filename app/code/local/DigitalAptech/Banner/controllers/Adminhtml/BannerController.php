...
class DigitalAptech_Banner_Adminhtml_BannerController extends Mage_Adminhtml_Controller_Action
{
...
//save image
		...
		{
			$fileName   = 'banner.csv';
			$grid       = $this->getLayout()->createBlock('banner/adminhtml_banner_grid');
