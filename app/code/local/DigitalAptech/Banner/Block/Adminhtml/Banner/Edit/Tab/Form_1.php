<?php
class DigitalAptech_Banner_Block_Adminhtml_Banner_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
		protected function _prepareForm()
		{
				...
				$fieldset = $form->addFieldset("banner_form", array("legend"=>Mage::helper("banner")->__("Item information")));
						...
						'values'   => DigitalAptech_Banner_Block_Adminhtml_Banner_Grid::getValueArray3(),
						'name' => 'status',
						));
						$fieldset->addField("details", "textarea", array(
						"label" => Mage::helper("banner")->__("Details"),
						"name" => "details",
						));
